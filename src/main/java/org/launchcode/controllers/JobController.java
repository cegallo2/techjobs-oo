...
public class JobController {
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors) {
        ...
        if (errors.hasErrors()) {
            ...
            CoreCompetency newCompetency = jobData.getCoreCompetencies().findById(jobForm.getCoreCompetencyId());

            Job newJob = new Job(newName, newEmployer,
                    newLocation, newPosition, newCompetency);
